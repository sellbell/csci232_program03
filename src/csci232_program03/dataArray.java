...
public class dataArray {
    ...
    public dataArray(int a)
    {
       ...
       mst = new Edge[a-1]; //initializes the array to hold the edges to the size of how many vertices there are minus one. Most edges there can be are vertices minus one otherwise loops
       max = a-1; //sets the maximum number of edges there can be without causing a loop
    ...
    public void prims()
    {
        ...
        while(max > 0) //While there are still edges that need to be accounted for
        {
            ...
            max--; //decrease the amount of possible edges left to check
